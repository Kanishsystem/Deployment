...
export class SiteSettingsComponent {
  ...
  tabs = [
    ...
    { value: 'license_documents', label: 'General Documents', icon: 'fa fa-file-pdf-o' },
    { value: 'forms_documents', label: 'Forms ', icon: 'fa fa-file-pdf-o' },
    { value: 'help', label: 'Help ', icon: 'fa fa-file-pdf-o' },
  ];
