...
@Component({
  selector: 'app-telephone-complaint-admin',
  templateUrl: './telephone-complaint-admin.component.html',
  styleUrls: ['./telephone-complaint-admin.component.css'],
})
export class TelephoneComplaintAdminComponent {
  ...
  mode_data = {
    emp:{
      title:" My Telephone Complaints",
      url:"SITE_TELEPHONE_GET_ALL_USER"
    },
    
    app:{
      title:"Telephone Complaints-Approval",
      url:"SITE_TELEPHONE_GET_ALL_APP"
    },
    admin:{
      title:"Telephone Complaints-Admin",
      url:"SITE_TELEPHONE_GET_ALL"
    },
      ...
      user_buttons: {
        ...
        btn_config: [
...

          {
            ...
            // btn_show:()=>{
            //   return this.status_disp['comp']=="10" ? true : false;
            // }
          },
        ],
      },
  ...
  openViewForm(data) {
    ...
    let get_one = get_api_route('SITE_TELEPHONE_ONE');
  ...
  openForm(data: any = null) {
    let options = {
      title: 'Telephone Complaint Form',
  ...
  editForm(data: any = null) {
    let options = {
      title: 'Telephone Complaint Update Form',
  ...
  delete_one() {
    let deleteUrl = get_api_route('SITE_TELEPHONE_DELETE_ONE');
  ...
  submitData(data) {
    this.api.smartPost('SITE_TELEPHONE_INSERT', data).subscribe((res: any) => {
  ...
  updateDate(data) {
    let id = data.ID !== undefined ? data.ID : 0;
    let update_url = get_api_route('SITE_TELEPHONE_UPDATE');
    data['id'] = id;
