...
@Component({
  selector: 'app-mechanical-complaints',
  templateUrl: './mechanical-complaints.component.html',
  styleUrls: ['./mechanical-complaints.component.css']
})
export class MechanicalComplaintsComponent {
  ...
  mode_data = {
    emp:{
      title:" My Mechanical Complaints",
      url:"SITE_MECHANICAL_GET_ALL_USER"
    },
    
    app:{
      title:"Mechanical Complaints-Approval",
      url:"SITE_MECHANICAL_GET_ALL_APP"
    },
    admin:{
      title:"Mechanical Complaints-Admin",
      url:"SITE_MECHANICAL_GET_ALL"
    },
  }
  /**
   * get mod data
  ...
  openViewForm(data) {
    ...
    let get_one = get_api_route('SITE_MECHANICAL_ONE');
  ...
  openForm(data: any = null) {
    ...
    let options = {
      title: 'Mechanical Complaint Form',
  ...
  editForm(data: any = null) {
    let options = {
      title: 'Mechanical Complaint Update Form',
  ...
  delete_one() {
    let deleteUrl = get_api_route('SITE_MECHANICAL_DELETE_ONE');
  ...
  submitData(data) {
    this.api.smartPost('SITE_MECHANICAL_INSERT', data).subscribe((res: any) => {
  ...
  updateDate(data) {
    let id = data.ID !== undefined ? data.ID : 0;
    let update_url = get_api_route('SITE_MECHANICAL_UPDATE');
    data['id'] = id;
