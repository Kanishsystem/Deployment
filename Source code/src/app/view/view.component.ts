...
export class ViewComponent {
  ...
  getWorkshopNavs(index) {
    this.dashboard_perm.push("SD_WORK_ADMIN");
    return [
      {
        title: 'My Workshop',
        icon: 'fa fa-grav',
  ...
  getShutdownNavs(index) {
    this.dashboard_perm.push("SD_ACV_SHUT_ADMIN");
    return [
      {
        title: 'ACV Shutdown',
        icon: 'fa fa-grav',
  ...
  getElcShutdownNavs(index) {
    this.dashboard_perm.push("SD_ELEC_SHUT_ADMIN");
    return [
      {
  ...
  getComplaintNavs(index) {
    this.dashboard_perm.push("SD_ELE_ADMIN");
    return [
      {
        title: 'My Complaints',
        icon: 'fa-brands fa-nfc-directional',
  ...
  getTelephoneComplaintNavs(index) {
    this.dashboard_perm.push("SD_TP_ADMIN");
    return [
      {
        title: 'My Complaints',
        icon: 'fa-brands fa-nfc-directional',
  ...
  getNetworkComplaintNavs(index) {
    this.dashboard_perm.push("SD_NW_ADMIN");
    return [
      {
        title: 'My Complaints',
        icon: 'fa-brands fa-nfc-directional',
  ...
  getMechanicalComplaintNavs(index) {
    this.dashboard_perm.push("SD_MECH_ADMIN");
    return [
      {
        title: 'My Complaints',
        icon: 'fa-brands fa-nfc-directional',
  ...
  getComNavs() {
   ...
   // console.log("complaints", this.comTypes);
    this.comTypes.forEach((element) => {
      ...
      this.dashboard_perm.push(admin_group);
      nav_array.push({
