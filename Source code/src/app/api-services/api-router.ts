...
//Help
  ...
  SITE_HELP_DOCUMENT_GET_ALL: 'user_site_helper/get_all',
  SITE_HELP_DOCUMENT_ONE: 'user_site_helper/get_one',
  SITE_HELP_DOCUMENT_INSERT: 'user_site_helper/insert',
  SITE_HELP_DOCUMENT_DELETE_ONE: 'user_site_helper/delete_one',
  SITE_HELP_DOCUMENT_GET_DOCUMENT: 'user_site_helper/get_doc',
  ...
  SITE_GALLERY_UPDATE: 'gallery/update',
  ...
  SITE_HISTORY_GET_ONE: 'history/get_one',
  SITE_HISTORY_UPDATE: 'history/update',
