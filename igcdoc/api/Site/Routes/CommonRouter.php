...
class CommonRouter
{
    ...
    private function document_routes()
    {
        ...
        $this->_routes["/document/get_all/admin/wait"] = [
            SmartConst::REQUEST_GET, $this->_admin_only, $controller,
        ...
        $this->_routes["/document/get_all/app/wait"] = [
            SmartConst::REQUEST_GET, $this->_admin_user, $controller,
    ...
    private function comman_complaint_routes()
    {
        ...
        $this->_routes["/complaint/get_all/admin/wait"] = [
            SmartConst::REQUEST_POST, $this->_admin_user, $controller,
            "getAll", ["mode" => "admin", "status" => [10, 14]]
        ];
    ...
    private function meet_proposal_routes(){
        ...
        [SmartConst::REQUEST_POST,$this->_admin_user,$controller,"getAll",
        ["mode" => "admin","status" => [5]]]; 
