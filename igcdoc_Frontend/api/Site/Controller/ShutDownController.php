...
use Site\Helpers\ShutdownHelper;


class ShutDownController extends BaseController
{
    private ShutdownHelper $_shutdown_helper;

    function __construct($params)
    {
        parent::__construct($params);
        // 
        $this->_shutdown_helper = new ShutdownHelper($this->db);
    }
    ...
    {
        $columns = ["from_date","to_date", "description"];
        // do validations
        $this->_shutdown_helper->validate(ShutdownHelper::validations, $columns, $this->post);
        // add other columns
        ...
        $this->db->_db->Begin();
        // insert and get id
        $id = $this->_shutdown_helper->insert($columns, $this->post);
         // upload the document
         $file_path = $this->_shutdown_helper->getFullFile($id);
         ...
         $this->_shutdown_helper->update($update_columns,$update_data,$id);   
         } 
    ...
    public function update()
    {
        ...
        // do validations
        $this->_shutdown_helper->validate(ShutdownHelper::validations, $valid_columns, $this->post);
        $columns = ["status","admin_remarks"];
        // add columns
        $columns[] = "last_modified_by";
        $columns[] = "last_modified_time";
        // insert and get id
        $id = $this->_shutdown_helper->update($columns, $this->post, $id);
        // add log
    ...
    public function getAll()
    {
        ...
        $data = $this->_shutdown_helper->getAllData($sql, $data_in);
        $this->response($data);
    }
    /**
     * 
    ...
    public function getOne()
    {
        ...
        // insert and get id
        $data = $this->_shutdown_helper->getOneData($id);
        $this->response($data);
    }
    /**
     * 
    ...
    public function deleteOne()
    {
        ...
        // insert and get id
        $this->_shutdown_helper->deleteOneId($id);
        // add log
