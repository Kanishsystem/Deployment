...
class DashboardController extends BaseController{
    ...
    public function getCounts(){        
        ...
        $db->shutdown = $this->_shutdown_helper->getCount($this->params["type"]);
        ...
        $db->shutdownByStatus = $this->_shutdown_helper->getCountByStatus();
   ...
   /**
    ...
    public function getCountsByYear(){        
        ...
        $db->shutdown = $this->_shutdown_helper->getCountByYear($this->params["year"]);
