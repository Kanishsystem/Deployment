...
class CommonRouter{
    ...
    private function workshop_routes(){
        ...
        $this->_routes["/workshop/get_all/admin/wait"] = [SmartConst::REQUEST_GET,$this->_admin_user,$controller,
        "getAll",["mode"=>"admin","status"=>[10,14]]];
        $this->_routes["/workshop/get_all/admin/process"] = [SmartConst::REQUEST_GET,$this->_admin_user,$controller,
        "getAll",["mode"=>"admin","status"=>[11,15]]];  
        $this->_routes["/workshop/get_all/user"] = [SmartConst::REQUEST_GET,$this->_admin_user,$controller,"getAll",["mode"=>"user"]]; 
        $this->_routes["/workshop/get_all/app/wait"] = [SmartConst::REQUEST_GET,$this->_admin_user,$controller,
        "getAll",["mode"=>"app","status"=>[5]]]; 
        $this->_routes["/workshop/get_all/app/process"] = [SmartConst::REQUEST_GET,$this->_admin_user,$controller,
        "getAll",["mode"=>"app","status"=>[6,10,15]]]; 
     ...
     * 
     */
    private function shutdown_routes(){
        $controller = "ShutDownController";    
        // 5 = submitted 6=app rejected 10=app approved 15= comlaint resolved 14=pending 11=invalid   
        $this->_routes["/shutdown/insert"] = [SmartConst::REQUEST_POST,$this->_admin_user,$controller,"insert"];
        $this->_routes["/shutdown/update"] = [SmartConst::REQUEST_POST,$this->_admin_user,$controller,"update"];
        $this->_routes["/shutdown/get_all/admin/wait"] = [SmartConst::REQUEST_GET,$this->_admin_user,$controller,
        "getAll",["mode"=>"admin","status"=>[10,14]]];
        $this->_routes["/shutdown/get_all/admin/process"] = [SmartConst::REQUEST_GET,$this->_admin_user,$controller,
        "getAll",["mode"=>"admin","status"=>[11,15]]];  
        $this->_routes["/shutdown/get_all/user"] = [SmartConst::REQUEST_GET,$this->_admin_user,$controller,"getAll",["mode"=>"user"]]; 
        $this->_routes["/shutdown/get_all/app/wait"] = [SmartConst::REQUEST_GET,$this->_admin_user,$controller,
        "getAll",["mode"=>"app","status"=>[5]]]; 
        $this->_routes["/shutdown/get_all/app/process"] = [SmartConst::REQUEST_GET,$this->_admin_user,$controller,
        "getAll",["mode"=>"app","status"=>[6,10,15]]]; 
        $this->_routes["/shutdown/get_one"] = [SmartConst::REQUEST_POST,$this->_admin_user,$controller,"getOne"];            
        $this->_routes["/shutdown/delete_one"] = [SmartConst::REQUEST_POST,$this->_admin_user,$controller,"deleteOne"];
        // approve
        $this->_routes["/shutdown/get_one_pdf"] = [SmartConst::REQUEST_POST,$this->_admin_user,$controller,"getOnePdf"];
